      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {products.map((product) => (
            <div key={product.id} className="glass-effect p-6 rounded-xl hover:transform hover:scale-105 transition-all duration-300 group border border-gray-200 shadow-lg hover:shadow-xl">
              ...
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold text-text-primary mb-2 mt-1">{product.name}</h3>
