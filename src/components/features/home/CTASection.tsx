      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="glass-effect rounded-2xl p-12 text-center border border-pink/20 shadow-xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button className="border-2 border-pink text-text-primary px-8 py-4 rounded-lg font-semibold text-lg hover:bg-pink hover:text-white transition-all duration-300">
