      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-6 mb-8">
              <div className="text-center">
                ...
                <h4 className="font-semibold text-text-primary">30+ Years</h4>
              ...
              <div className="text-center">
                ...
                <h4 className="font-semibold text-text-primary">10,000+</h4>
          ...
          <div className="relative">
            <div className="aspect-square bg-white rounded-2xl flex items-center justify-center border border-gray-200 shadow-lg">
              <div className="text-center">
                <div className="w-32 h-32 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-6 border border-gray-200 shadow-lg">
                  <svg className="w-16 h-16 text-pink" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                  </svg>
                </div>
                <h3 className="text-2xl font-semibold text-text-primary mb-2">Our Workshop</h3>
                <p className="text-text-secondary">Where magic happens</p>
              </div>
            </div>
          </div>
        </div>
