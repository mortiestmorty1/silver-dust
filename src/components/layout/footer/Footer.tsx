export default function Footer() {
  return (
    <footer className="border-t border-pink/20 py-12 bg-white/50 shadow-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#necklaces" className="text-pink-dark hover:text-pink transition-colors">Necklaces</a></li>
              <li><a href="#earrings" className="text-pink-dark hover:text-pink transition-colors">Earrings</a></li>
              <li><a href="#about" className="text-pink-dark hover:text-pink transition-colors">About Us</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#returns" className="text-pink-dark hover:text-pink transition-colors">Returns</a></li>
              <li><a href="#size-guide" className="text-pink-dark hover:text-pink transition-colors">Size Guide</a></li>
              <li><a href="#care" className="text-pink-dark hover:text-pink transition-colors">Jewelry Care</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-pink/20 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6 mt-4 md:mt-0">
              <a href="#privacy" className="text-pink-dark hover:text-pink text-sm transition-colors">Privacy Policy</a>
              <a href="#terms" className="text-pink-dark hover:text-pink text-sm transition-colors">Terms of Service</a>
              <a href="#cookies" className="text-pink-dark hover:text-pink text-sm transition-colors">Cookie Policy</a>
            </div>
          </div>
        </div>
      </div>
